  ...
  return (
    <div className="mx-auto flex min-h-[78vh] max-w-md items-center">
      <GlassCard className="w-full p-6 sm:p-8">
        <p className="text-sm uppercase tracking-[0.22em] text-sky-700">Password recovery</p>
        <h1 className="mt-3 text-3xl font-semibold text-slate-900">Reset access</h1>
        <p className="mt-3 text-slate-600">We&apos;ll send a secure link if your account exists.</p>
